...
scenarios('../feature/projects.feature')
...
def create_a_project(client, context):
    project = create_random_project(client, context)
...
def verify_project_name_updated(client, context):
    response = client.get(f'/projects/', headers = context['headers'])
...
def update_project_team(client, context):
    ...
    team1 = create_random_team(client, context)
    team2 = create_random_team(client, context)
